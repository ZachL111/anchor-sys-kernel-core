"""Regression checks for the anchor-sys-kernel-core casebook."""
...
from casebook.harness import assert_expected, anchor_sys_kernel_core_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(anchor_sys_kernel_core_summary(), assert_expected())
